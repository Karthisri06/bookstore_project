...
const App: React.FC = () => {
  ...
  const isLoggedIn = isAdmin || isAuthor || isUser;
    ...
    <>
      ...
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route path="/admin/books" element={isAdmin ? <ManageBooks /> : <Navigate to="/" />} />
          <Route path="/admin/orders" element={isAdmin ? <AllOrders /> : <Navigate to="/" />} />

          <Route path="/author" element={isAuthor ? <AuthorDashboard /> : <Navigate to="/" />} />
