...
export class Updatedreview1745415293876 implements MigrationInterface {
    name = 'Updatedreview1745415293876'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`purchase\` ADD \`totalPrice\` decimal NOT NULL`);
